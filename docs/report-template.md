...
- Основна гілка: `main`.
- Фінальний тег: `v0.1.0` (annotated, «Laboratory work 1 complete»).
- Commit hash: `77579c133ddd65372000d4da5d732bc29959c76d` (короткий — `77579c1`).

Тег створено на перевіреному стані основної гілки. Звірка виконана:

```text
git rev-parse HEAD       -> 77579c133ddd65372000d4da5d732bc29959c76d
git rev-list -n 1 v0.1.0 -> 77579c133ddd65372000d4da5d732bc29959c76d
```

Значення збігаються. Перед тегуванням на гілці `main` повторно виконано
релевантні перевірки: збірка в конфігурації Release завершилася без попереджень
і помилок, усі чотири тести пройдено.
